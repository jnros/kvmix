...
**The cast bug:** `(int8_t) x` vs `(int8_t) nearbyintf(x)`. Ensure use of nearbyintf() when casting for quantization. The first naive syntax round all decimals down to 0, introduces ~4x MSE. Nearly universal in C/C++ quant code.
